      ...
      {Object.entries(links).map(([platform, url]) => {
        ...
        return (
          <a
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full border border-white/20 text-white/60 transition-all duration-200 hover:scale-110"
            aria-label={`Follow us on ${labels[platform] ?? platform}`}
