...
import { MessageCircle, Phone, Mail, Package, ChevronRight } from 'lucide-react';
import { products, getProductBySlug, getRelatedProducts, getProductSlugs } from '@/data/products';
